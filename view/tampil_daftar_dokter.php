  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
	  ...
	  echo '<div class="alert alert-danger text-center" role="alert" style="position: absolute;top: 55px;width: 100%"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><b>Dokter gagal diupdate!</b></div>';
  	 ...
  	 ?>
		...
		<h1 class="text-center" style="margin-top: 50px;">Daftar Dokter</h1>
		<br>
		<br>
	...
	<div class="card text-center" style="width: 97%;">
	  <div class="card-header">
	    <ul class="nav nav-tabs card-header-tabs">
	      ...
	      <li class="nav-item">
	        <a class="nav-link active" href="tampil_daftar_dokter.php">Daftar Dokter</a>
	      </li>
	      <li class="nav-item">
	  ...
	  <div class="card-body text-left">
			<table style="width: 100%;">
				<tr>
					<td>	
					<button class="btn btn-success" style="float: right;right: 0;" type="button" data-toggle="modal" data-target="#tambahDokter">Tambah Dokter</button>
					</td>
				</tr>
			</table>
			<?php 
				include 'tabel_daftar_dokter.php';
			 ?>
	...
	<!-- modal tambah -->
	<!-- Modal -->
	<div class="modal fade" id="tambahDokter" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-scrollable" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	       ...
	       <form action="../proses/proses_simpan_dokter.php" method="post" enctype="multipart/form-data">
	       		...
	       		<div class="form-group">
	       			...
	       			<input type="text" class="form-control" maxlength="100" name="nip" placeholder="Nomer Induk Pegawawai Dokter">
	       		</div>
	       		<div class="form-group">
	       			<label for="telp">No. Telp</label>
	       			<input type="text" class="form-control" maxlength="15" name="telp" placeholder="No. Telp Dokter">
	       		</div>
	       		<div class="form-group">
	       			<label for="spesialis">Spesialis</label>
	       			<select class="custom-select mr-sm-2" id="spesialis" name="spesialis">
